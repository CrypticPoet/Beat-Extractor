...
audio_file, sample_rate = librosa.load('song.wav', sr=None, res_type = 'kaiser_fast')
...
for i in range(0, len(beat_frames)) :
    if beat_strengths[i] > 6.8475 :     #6.8475 is a tried and tested threshold for now. Working on an algo
